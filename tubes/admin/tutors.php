...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><img src="../gambar/<?php echo tutors_foto($r1['id'])?>" style="max-height:100px;max-width:100px" />
            </td>
...
<!-- Pages -->
<h1 class="mt-2">Halaman Admin Tutors</h1>
...
<form class="row g-3" method="get">
    ...
    <div class="container no-print">
        ...
        <a href="?generate_pdf" class="btn btn-danger"> Print PDF</a>
    </div>
</form>
